...
class Expeditions(commands.Cog):
    ...
    @commands.command(
        description='Send a character that you own on an Expedition to gather materials',
    ...
    @commands.command(
        description='Show the characters currently on Expeditions and the time remaining on them',
    ...
    @commands.command(
        description='Increase the amount of characters allowed to go on Expeditions',
    ...
    @commands.command(
        description='Displays what the user can get from expeditions',
